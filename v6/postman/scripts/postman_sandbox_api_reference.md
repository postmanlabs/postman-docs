...
`pm.expect(assertion:*):Function → Assertion`
  ...
  This function is useful to deal with assertions of data from a `response` or `variables`. For assertion test examples using `pm.exect`, check out [Assertion library examples](/docs/v6/postman/scripts/test_examples#assertion-library-examples).
