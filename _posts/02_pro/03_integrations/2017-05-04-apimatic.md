...
This integration allows APIMatic to convert your Postman Collections into any major API description format, and then saves the resulting file into your designated GitHub repository. <br> 
