...
BigPanda gives you real-time alerting based on the results of your Postman Monitors. If there was a test fails or if an error occurs during the run, BigPanda sends an alert.
