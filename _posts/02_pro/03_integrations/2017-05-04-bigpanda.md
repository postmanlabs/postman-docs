...
Choose the monitor you want to receive alerts. Then, enter the App Key and the API Key you generated earlier.
...
BigPanda gives you real-time alerting based on the results of your Postman Monitors. If there was a failed test or if an error occurred during the run, BigPanda sends an alert.
