...
You can individually add key-value pairs,  which Postman combines as a query string. If your URL already has parameters - for example, if you are pasting a URL from some other source, Postman automatically splits the URL into pairs.
